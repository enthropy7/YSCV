...
def main() -> None:
    ...
    ops: List[OpSpec] = [
        ...
        ("sum_1M", lambda x, _y: torch.sum(x), [1024, 1024]),
        ("max_1M", lambda x, _y: torch.max(x), [1024, 1024]),
        ("add_broadcast_1024x1024_by_1024", lambda x, y: x + y[0], [1024, 1024]),
        ("sub_broadcast_1024_by_1024x1024", lambda x, y: x[0] - y, [1024, 1024]),
